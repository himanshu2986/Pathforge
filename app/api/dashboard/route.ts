    ...
    if (!dashboard) {
      const defaultLearningPaths = [
        { 
          ...
          progress: 0, 
          modules: [ 
            { id: '1a', title: 'HTML & CSS Fundamentals', completed: false, content: 'HTML (HyperText Markup Language) is the standard markup language for web browsers.\n\nKey Concepts:\n- Elements and Tags\n- Document Structure\n- CSS Selectors and Box Model', example: '<!-- Basic HTML Structure -->\n<!DOCTYPE html>\n<html>\n<head>\n<style>\n  .box { \n    background: #ec4899; \n    padding: 20px; \n    color: white; \n    border-radius: 12px; \n  }\n</style>\n</head>\n<body>\n  <div class="box">\n    <h1>Hello Pathforce!</h1>\n  </div>\n</body>\n</html>', quiz: [{ question: "What does HTML stand for?", options: ["Hyper Tool Markup Language", "HyperText Markup Language", "High Tech Modern Language"], answer: 1 }, { question: "Which property is part of the CSS Box Model?", options: ["padding", "color", "font-size"], answer: 0 }] }, 
        ...
        { 
          ...
          progress: 0, 
          modules: [ 
            { id: '2a', title: 'Python for ML', completed: false, content: 'Python is the language of AI. Libraries like NumPy and Pandas provide the power required for model building.', example: '<script>\n  const data = [1.2, 2.3, 3.4, 4.5];\n  const mean = data.reduce((a,b)=>a+b)/data.length;\n  document.body.innerHTML = `<h1>Data Analysis</h1><p>Processed: ${data.length} nodes</p><p>Vector Mean: ${mean}</p>`;\n</script>', quiz: [{ question: "Which library is most commonly used for numerical computations in Python?", options: ["Pandas", "NumPy", "Matplotlib"], answer: 1 }] }, 
