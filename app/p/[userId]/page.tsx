...
export default function PublicArchitectPortfolio() {
  ...
  return (
    <div className="min-h-screen bg-[#07090f] text-white selection:bg-primary/30 overflow-x-hidden relative">
      ...
      <nav className="fixed top-0 inset-x-0 h-16 md:h-20 z-50 bg-[#07090f]/80 backdrop-blur-xl border-b border-white/5 flex items-center justify-between px-3 md:px-8 lg:px-20">
         <div className="flex items-center gap-2 md:gap-3">
            ...
            <span className="text-[14px] md:text-xl font-black italic tracking-tighter">PATHFORGE <span className="hidden lg:inline text-gray-600 font-normal uppercase text-xs ml-1">ARCHITECT</span></span>
         </div>
         <div className="flex items-center gap-2 md:gap-4">
            ...
            {user?.id === profile.id || user?.id === 'demo-user' ? (
              ...
              <a href={`mailto:zester830@gmail.com?subject=Inquiry for ${profile.name} (via Pathforge Architect)`} className="px-3 md:px-5 py-2 md:py-2.5 bg-white text-black rounded-lg md:rounded-xl text-[9px] md:text-[10px] font-black uppercase tracking-widest flex items-center gap-2 hover:bg-slate-200 transition-all shadow-xl shadow-white/10">
